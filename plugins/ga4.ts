...
import type { Event } from "https://raw.githubusercontent.com/denoland/ga4/04a1ce209116f158b5ef1658b957bdb109db68ed/mod.ts";
import {
  GA4Report,
  isDocument,
  isServerError,
...
function ga4(
  ...
  Promise.resolve().then(async () => {
    ...
    const report = new GA4Report({
      ...
      response,
      conn: {
        localAddr: context.info.remoteAddr,
        remoteAddr: context.info.remoteAddr,
      },
    });
